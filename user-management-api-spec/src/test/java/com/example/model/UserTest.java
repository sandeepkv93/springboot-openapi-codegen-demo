...
class UserTest {
  ...
  class EmailValidation {
    ...
    @ValueSource(strings = {"", "invalid", "@example.com", "john@", "john@.com", "@.com"})
    void shouldRejectInvalidEmails(String invalidEmail) {
      // Given
      User user = new User().name("John Doe").email(invalidEmail);
  ...
  class NameValidation {
    ...
    void shouldRejectEmptyName() {
      // Given
      User user = new User().name("").email("john.doe@example.com");
    ...
    void shouldRejectTooLongName() {
      ...
      User user = new User().name(longName).email("john.doe@example.com");
